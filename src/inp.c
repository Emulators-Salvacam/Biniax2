...
BNX_BOOL inpInit()
{
	...
	_Inp.keyShiftLeft= BNX_FALSE;
	_Inp.keyCtrlLeft= BNX_FALSE;
...
BNX_BOOL inpKeyShiftLeft()
{
	if ( _Inp.keyShiftLeft == BNX_TRUE )
	{
		_Inp.keyShiftLeft = BNX_FALSE;
		return BNX_TRUE;
	}
...
BNX_BOOL inpKeyCtrlLeft()
{
	if ( _Inp.keyCtrlLeft == BNX_TRUE )
	{
		_Inp.keyCtrlLeft = BNX_FALSE;
		return BNX_TRUE;
	}
